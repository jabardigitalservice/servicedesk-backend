...
test('should able to retrieved JWKS info', async ({ assert, browser }) => {
 
  const page = await browser.visit(process.env.JWKS)
  await page.assertHas(
    "{\"keys\":[{\"kid\":\"85unpCvPG3CCcTxKWgrd_cfWSi3uQGXOfbIVEzDePAk\",\"kty\":\"RSA\",\"alg\":\"RS256\",\"use\":\"sig\",\"n\":\"yZOvEJ1n5W78DOJ7Ifj2J7Ici-FzNjKLHyS_FFxFdNQR8x909Y1_GW9uSAy2fNAANDbu5TEhh5tx4q3rXbMJ9gKiKtY8-OFAdOUrAvzBtlfr2FYaz-RVcJklJ5SS1Ax-A1OKrGgenpZn5ng5XGJ4sZae1c5lidyDSo67fO8z6IyWZPCuCbMT-rdadGVe0gSL0Ia3pbDpYzBtblWAT74BC61fFe19O9Qpiy5P1P0Is2CsDXJIfkwj0eeWgVimoCYMycp0CBqIZ_HdHmT3PuKBtE1Pao8vj7IaHz1NLYZK-mCn7vJIhpf_dZi8X2x7Dop4dMOYRA8qnbIGhNuL7fhWzQ\",\"e\":\"AQAB\",\"x5c\":[\"\"],\"x5t\":\"yrC-RiGq7eQTvYmrowPsJxaBgiM\",\"x5t#S256\":\"ItEK3FjBigA6Q0EDJiP-UgtyTcj1dlT4kvmSzuHOjH0\"}]}"
  )
});

test('should able to retrieved token when given valid input', async ({assert, client}) => {
